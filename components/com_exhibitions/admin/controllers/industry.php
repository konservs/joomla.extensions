...
/**
 * Single Industry controller
 *
 * @author Andrii Biriev, a@konservs.com
 * @author Maksym Kutyshenko, mkutyshenko@gmail.com
 */
class ExhibitionsControllerIndustry extends JControllerForm{
	/**
	...
	public function save($key = null, $urlVar = null){
		...
		$data=$jinput->get('industry', array(),'array');
		//var_dump($data);die();
		//TODO get record ID;
		$urlVar='ind_id';
		if(!$model->save($data)){
	...
	public function delete(){			
		...
		$this->setRedirect('index.php?option='.$this->option.'&view='.$this->view_list);
		$app->enqueueMessage(JText::_('COM_EXHIBITIONS_INDUSTRY_DELETED').var_export(implode(', ', $cid),true), 'message');	
		return true;	
		}		
	}
