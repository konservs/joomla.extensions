...
class ExhibitionsViewExhibition extends JViewLegacy{
	...
	*/
	protected function addToolBar(){
		...
		JToolBarHelper::title($isNew ? JText::_('COM_EXHIBITIONS_EXHIBITION_NEW') : JText::_('COM_EXHIBITIONS_EXHIBITION_EDIT'), 'exhibition');
		JToolBarHelper::apply('exhibition.apply', 'JTOOLBAR_APPLY');
		JToolBarHelper::save('exhibition.save');
