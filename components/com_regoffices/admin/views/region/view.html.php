...
class RegofficesViewRegion extends JViewLegacy{
	...
	*/
	protected function addToolBar(){
		...
		JToolBarHelper::title($isNew ? JText::_('COM_REGOFFICES_REGION_NEW') : JText::_('COM_REGOFFICES_REGION_EDIT'), 'region');
		JToolBarHelper::apply('region.apply', 'JTOOLBAR_APPLY');
		JToolBarHelper::save('region.save');
		JToolBarHelper::cancel('region.cancel', $isNew ? 'JTOOLBAR_CANCEL' : 'JTOOLBAR_CLOSE');
		}
	}
