...
<?php foreach($this->items as $i=>$item): ?>
	<tr>
		...
		<!-- Country name -->
		<?php $url=JRoute::_('index.php?option=com_regoffices&task=region.edit&id='.$item->id); ?>
		...
		<td align="center">
			...
			<?php echo JHtml::_('jgrid.published', ($item->status=='P'), $i, 'regions.', $canChange, 'cb'); ?>
		</td>
		<!-- -->
		<?php $uri_site=$router->build('index.php?option=com_regoffices&view=region&id='.$item->id); $url_site=$uri_site->toString(); ?>
