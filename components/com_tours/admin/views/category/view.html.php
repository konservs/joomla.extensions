 ...
 */
class ExhibitionsViewIndustry extends JViewLegacy{
	/**
	* Сообщение.
	*
	* @var  object
	...
	*/
	protected function addToolBar(){
		...
		JToolBarHelper::title($isNew ? JText::_('COM_EXHIBITIONS_INDUSTRY_NEW') : JText::_('COM_EXHIBITIONS_INDUSTRY_EDIT'), 'industry');
		JToolBarHelper::apply('industry.apply', 'JTOOLBAR_APPLY');
		JToolBarHelper::save('industry.save');
		JToolBarHelper::cancel('industry.cancel', $isNew ? 'JTOOLBAR_CANCEL' : 'JTOOLBAR_CLOSE');
		}
	}
