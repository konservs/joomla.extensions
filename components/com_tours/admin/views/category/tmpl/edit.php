...
$isNew = ($id == 0);
$faction=JRoute::_('index.php?option=com_exhibitions&view=industry&layout=edit&ind_id='.$id);
//---------------------------------------------
...
echo('<form action="'.$faction.'" method="post" name="adminForm" id="industries-form">');
//---------------------------------------------
